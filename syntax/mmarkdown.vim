...
" ===HILIGHTING===
	...
	" FORMATTING
		...
		hi def mmdFormatRules cterm=bold
		...
		" Colours
			...
			" Font Faces
				...
				hi def mmdFormatCode              ctermfg=cyan
					...
					hi def mmdFormatItalics                        cterm=italic
						...
						hi def mmdFormatItalicsUnderlineStrike cterm=italic,underline
						" hi def mmdFormatItalicsStrike          cterm=italic,strikethrough
						" hi def mmdFormatItalicsStrike          cterm=italic
					...
					hi def mmdFormatAllPlus                        cterm=italic,bold,underline
